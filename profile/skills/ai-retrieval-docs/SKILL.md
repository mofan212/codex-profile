...
description: 维护中文 AI 检索文档、排查文档、上下文入口和检索入口。当用户要求根据需求、代码变更、指定模块或功能、既有入口路由，更新业务语义、代码事实、执行链路、兼容边界、验证命令、排查关键词和渐进加载路径，或未指定具体文档但要求维护项目级 AI 检索或上下文文档时，使用该 Skill。不适用于普通 Markdown 润色、需求设计、实现记录、Mermaid 图、纯查找现有文档或非检索类文档。
---
