...
本文只记录单个 Ticket 完成后产生的实现事实，供后续 `ai-retrieval-docs` 归并为正式 AI 检索文档。
...
`.feat-tmp/` 是临时工作区。正式归档时，使用 `ai-retrieval-docs` 读取需求文档、`.feat-tmp/tickets/` 下的实现沉淀文件、实际代码 diff、相关源码、测试、配置和已有 AI 检索文档后，生成或更新最终 AI 检索文档。
